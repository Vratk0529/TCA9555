...
bool TCA9555::pinMode8(uint8_t port, uint8_t mask) {
  ...
  _error = TCA9555_OK;
  if (port == 0)
    return writeRegister(TCA9555_CONFIGURATION_PORT_0, mask);
...
bool TCA9555::write8(uint8_t port, uint8_t mask) //  port = 0..1
{
  ...
  _error = TCA9555_OK;
  if (port == 0)
    return writeRegister(TCA9555_OUTPUT_PORT_REGISTER_0, mask);
...
int TCA9555::read8(uint8_t port) {
  ...
  _error = TCA9555_OK;
  if (port == 0)
    return readRegister(TCA9555_INPUT_PORT_REGISTER_0);
...
bool TCA9555::setPolarity8(uint8_t port, uint8_t mask) {
  ...
  _error = TCA9555_OK;
  if (port == 0)
    return writeRegister(TCA9555_POLARITY_REGISTER_0, mask);
...
uint8_t TCA9555::getPolarity8(uint8_t port) {
  ...
  _error = TCA9555_OK;
  if (port == 0)
    return readRegister(TCA9555_POLARITY_REGISTER_0);
...
//
TCA9535::TCA9535(uint8_t address, TwoWire *wire) : TCA9555(address, wire) {
  _type = 35;
}

PCA9555::PCA9555(uint8_t address, TwoWire *wire) : TCA9555(address, wire) {
  _type = 55;
}

PCA9535::PCA9535(uint8_t address, TwoWire *wire) : TCA9555(address, wire) {
  _type = 35;
}

CAT9555::CAT9555(uint8_t address, TwoWire *wire) : TCA9555(address, wire) {
  _type = 55;
}
